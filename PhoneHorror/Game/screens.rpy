...
screen phonestart():
    vbox xalign 1.0 yalign 1.0 xpos 1000 ypos 1050 :
        imagebutton auto "button_%s.png" action Jump ('story_start')

screen home1():
    vbox xalign 1.0 yalign 1.0 xpos 1000 ypos 1050 :
        imagebutton auto "button_%s.png" action Jump ('aftermenu')
screen home_menu():
    fixed:
        textbutton "Witch App" xalign 0.33 yalign 0.5 action Jump ('WitchApp')
        textbutton "Contacts" xalign 0.66 yalign 0.5 action Jump ('contacts1')
